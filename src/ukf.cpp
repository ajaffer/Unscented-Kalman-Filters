  ...
  if (!is_initialized_)
  {
    ...
    */
    ...
    if (meas_package.sensor_type_ == MeasurementPackage::RADAR)
    {
      ...
      */
      cout << "Radar" << endl;
      VectorXd cartesian_meas = tools.PolarToCartesian(meas_package.raw_measurements_);

      x_(0) = cartesian_meas[0];
      x_(1) = cartesian_meas[1];
    }
...
void UKF::Prediction(double delta_t)
{
  ...
  */
  ...
  // Xsig_aug.topLeftCorner(n_aug_, 1) = x_aug;
  ...
  std::cout << "Aug sigma points: " << std::endl
            << Xsig_aug << std::endl;
  ...
  // std::cout << "Predicting state mean" << std::endl;
  ...
  std::cout << "Predicted state covariance matrix :" << P_ << std::endl;
  std::cout << "|| Prediction(" << delta_t << ")" << std::endl;
}
...
void UKF::UpdateRadar(MeasurementPackage meas_package)
{
  ...
  */
  ...
  std::cout << "** UpdateRadar(" << meas_package.raw_measurements_ << ")" << std::endl;
